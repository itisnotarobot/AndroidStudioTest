...
public class CRUD {
    ...
    public Note getNote(long id){
        ...
        @SuppressLint("Recycle") Cursor cursor = db.query(NoteDatabase.TABLE_NAME,columns,NoteDatabase.ID + "=?",
    ...
    public List<Note> getAllNotes(){
        @SuppressLint("Recycle") Cursor cursor = db.query(NoteDatabase.TABLE_NAME,columns,null,null,null, null, null);
